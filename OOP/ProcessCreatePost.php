...
class ProcessCreatePost extends Middleware
{
    ...
    public function save()
    {
        ...
        $sql = "INSERT INTO posts (user_id, title, body, photo, created_at, updated_at) VALUES ('$user->id', '$this->title', '$this->body', '$this->filePath', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)";
